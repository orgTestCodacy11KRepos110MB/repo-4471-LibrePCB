...
#ifndef LIBREPCB_BOARDPREVIEWPAINTER_H
#define LIBREPCB_BOARDPREVIEWPAINTER_H
 ...
 */
class BoardPreviewPainter final : public GraphicsPagePainter {
  struct Trace {
    QString layerName;
    Point startPosition;
    Point endPosition;
...
public:
  ...
  BoardPreviewPainter() = delete;
  explicit BoardPreviewPainter(const Board& board);
  BoardPreviewPainter(const BoardPreviewPainter& other) = delete;
  ~BoardPreviewPainter() noexcept;
  ...
  BoardPreviewPainter& operator=(const BoardPreviewPainter& rhs) = delete;
